...
- rename_file     : path (bắt buộc), new_name (bắt buộc)
- create_file     : path (bắt buộc), is_folder (mặc định false)
...
User: "Tìm sâu hơn, quét cả thư mục con"
→ {"tool": "search_files", "params": {"pattern": "*.pdf", "folder": "C:/Users/{username}/Downloads", "max_depth": 6}, "confirm": false, "message": "Tìm PDF sâu 6 tầng"}
...
User: "Tóm tắt file báo cáo.pdf"
→ {"tool": "summarize_file", "params": {"path": "C:/Users/{username}/Downloads/báo cáo.pdf"}, "confirm": false, "message": "Tóm tắt nội dung file"}
